...
use XigeCloud\Files\Adapters\ConnectionFactory as AdapterFactory;
use XigeCloud\Files\Cache\ConnectionFactory as CacheFactory;
...
class FlysystemFactory
{
     ...
     *
     * @var \XigeCloud\Files\Adapters\ConnectionFactory
     */
    protected $adapter;
     ...
     *
     * @var \XigeCloud\Files\Cache\ConnectionFactory
     */
    protected $cache;
     ...
     *
     * @param \XigeCloud\Files\Adapters\ConnectionFactory $adapter
     * @param \XigeCloud\Files\Cache\ConnectionFactory    $cache
     *
     * @return void
     */
     ...
     *
     * @param array                                      $config
     * @param \XigeCloud\Files\FlysystemManager $manager
     *
     ...
     *
     * @return \XigeCloud\Files\Adapters\ConnectionFactory
     */
     ...
     *
     * @return \XigeCloud\Files\Cache\ConnectionFactory
     */
